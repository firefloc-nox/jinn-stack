...
Connectors are modular adapters that bridge external messaging platforms with Noxis's session manager.
...
- Default: messages route to the default employee (Noxis)
