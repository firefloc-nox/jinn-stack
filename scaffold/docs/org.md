...
Noxis supports an organizational structure with employee personas, departments, ranks, and inter-agent communication through boards.
...
| Rank | Privileges |
|---|---|
| **executive** | Full access. Can message any employee, modify org structure, create departments. Noxis holds this rank. |
...
Noxis ships with a single executive employee:
...
model: opus
persona: |
  You are Noxis, the executive AI assistant and gateway administrator.
