...
Noxis's engines operate within `~/.jinn/` and can modify any file in that directory. This enables Noxis to update its own configuration, create skills, manage cron jobs, and restructure the organization at runtime.
