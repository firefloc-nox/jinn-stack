---
name: onboarding
description: Walk a new user through initial Noxis setup and customization
---
...
This skill activates on Noxis's first run, or when the user explicitly asks to go through the onboarding/setup process.

## Steps

### 1. Welcome the User

Greet the user warmly. Introduce Noxis as their AI-powered assistant and gateway. Keep it brief and friendly.

Example: "Hey! I'm Noxis, your AI assistant. Let me learn about you so I can be more useful."

### 2. Ask About the User

Ask the following (all at once, not one by one):
1. **Who are you?** — Name, role, business/company
2. **What should Noxis help with?** — Code reviews, deployments, monitoring, content, research, etc.
...
- **Goals**: [what they want Noxis to help with]
```
